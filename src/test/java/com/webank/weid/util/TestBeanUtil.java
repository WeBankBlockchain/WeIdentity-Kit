...
public class TestBeanUtil {
    ...
    public void testPrint() {
        ...
        logger.info(
            BeanUtil.objToString(new ResponseData<PasswordKey>(passwordKey, KitErrorCode.SUCCESS))
        );
        ...
        logger.info(BeanUtil.objToString(new ResponseData<List<Object>>(list, KitErrorCode.SUCCESS)));

        map.put("list", list);
        map.put("response", new ResponseData<List<Object>>(list, KitErrorCode.SUCCESS));
        logger.info(BeanUtil.objToString(map));
