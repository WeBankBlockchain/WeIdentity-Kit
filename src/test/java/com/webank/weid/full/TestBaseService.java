...
public abstract class TestBaseService extends BaseTest {
    ...
    private void initIssuer(String fileName) {
        ...
        com.webank.weid.protocol.response.ResponseData<String> response1 = weIdService.createWeId(createWeIdArgs1);
        if (response1.getErrorCode().intValue() != KitErrorCode.WEID_ALREADY_EXIST.getCode()
            && response1.getErrorCode().intValue() != KitErrorCode.SUCCESS.getCode()) {
            Assert.assertTrue(false);
        }
        ...
        com.webank.weid.protocol.response.ResponseData<Boolean> response =
    ...
    protected ResponseData<Boolean> verifyCredential(Credential credential) {
        ...
        com.webank.weid.protocol.response.ResponseData<Boolean> response = credentialService.verify(credential);
        return new ResponseData<>(response.getResult(), KitErrorCode.getTypeByErrorCode(response.getErrorCode()));
    }
    ...
    protected ResponseData<Boolean> verifyCredentialPojo(CredentialPojo credentialPojo) {
        ...
        com.webank.weid.protocol.response.ResponseData<Boolean> response = credentialPojoService.verify(
    ...
    protected ResponseData<Boolean> verifyCredentialPojo(
        ...
        com.webank.weid.protocol.response.ResponseData<Boolean> response = credentialPojoService
    ...
    protected CredentialWrapper createCredential(CreateCredentialArgs createCredentialArgs) {
        ...
        com.webank.weid.protocol.response.ResponseData<CredentialWrapper> response =
    ...
    protected CredentialPojo createCredentialPojo(
        ...
        com.webank.weid.protocol.response.ResponseData<CredentialPojo> response = credentialPojoService
    ...
    protected CredentialPojo createSelectiveCredentialPojo(CredentialPojo credentialPojo) {
        ...
        com.webank.weid.protocol.response.ResponseData<CredentialPojo> response =
    ...
    protected CptBaseInfo registerCpt(
        ...
        com.webank.weid.protocol.response.ResponseData<CptBaseInfo> response = cptService.registerCpt(registerCptArgs);
    ...
    protected void registerAuthorityIssuer(CreateWeIdDataResult createWeId) {
        ...
        com.webank.weid.protocol.response.ResponseData<Boolean> response = new com.webank.weid.protocol.response.ResponseData<Boolean>(false,
                com.webank.weid.constant.ErrorCode.AUTHORITY_ISSUER_CONTRACT_ERROR_NAME_ALREADY_EXISTS);

        while (response.getErrorCode()
            == KitErrorCode.AUTHORITY_ISSUER_CONTRACT_ERROR_NAME_ALREADY_EXISTS.getCode()) {
    ...
    protected CreateWeIdDataResult createWeId() {
        ...
        com.webank.weid.protocol.response.ResponseData<com.webank.weid.protocol.response.CreateWeIdDataResult> createWeIdDataResult = weIdService.createWeId();
        LogUtil.info(logger, "createWeId", createWeIdDataResult);

        Assert.assertEquals(KitErrorCode.SUCCESS.getCode(),
    ...
    protected void setService(
        ...
        com.webank.weid.protocol.response.ResponseData<Boolean> responseSetSer = weIdService.setService(createResult.getWeId(),
            setServiceArgs, createResult.getUserWeIdPrivateKey());
        LogUtil.info(logger, "setService", responseSetSer);

        Assert.assertEquals(KitErrorCode.SUCCESS.getCode(), responseSetSer.getErrorCode().intValue());
    ...
    protected void setAuthentication(
        ...
        com.webank.weid.protocol.response.ResponseData<Boolean> responseSetAuth =
        ...
        Assert.assertEquals(KitErrorCode.AUTHENTICATION_PUBLIC_KEY_MULTIBASE_EXISTS.getCode(), responseSetAuth.getErrorCode().intValue());
