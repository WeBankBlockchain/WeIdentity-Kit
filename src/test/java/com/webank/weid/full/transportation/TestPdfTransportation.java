...
public class TestPdfTransportation extends TestBaseTransportation {
    ...
    public void testSerializeCase310() {
        ResponseData<Boolean> response = TransportationFactory.newPdfTransportation()
            .serialize(presentation4MultiCpt,
                ...
                "");
        LogUtil.info(logger, "serialize", response);
        Assert.assertEquals(KitErrorCode.ILLEGAL_INPUT.getCode(), response.getErrorCode().intValue());
        Assert.assertTrue(!response.getResult());
    }
    ...
    public void testSerializeCase11() {
        ...
        LogUtil.info(logger, "serialize", response);
        Assert.assertEquals(
            KitErrorCode.ILLEGAL_INPUT.getCode(),
            response.getErrorCode().intValue());
        Assert.assertNull(response.getResult());
    }
    ...
    public void testSerializeCase12() {
        ...
        LogUtil.info(logger, "serialize", response);
        Assert.assertEquals(
            KitErrorCode.ILLEGAL_INPUT.getCode(), response.getErrorCode().intValue());
        Assert.assertNull(response.getResult());
    }
    ...
    public void testSerializeCase13() {
        ...
        LogUtil.info(logger, "serialize", response);
        Assert.assertEquals(
            KitErrorCode.TRANSPORTATION_PDF_TRANSFER_ERROR.getCode(),
            response.getErrorCode().intValue());
        Assert.assertNull(response.getResult());
    }
    ...
    public void testDeserializeCase1() {
        ...
        Assert.assertEquals(KitErrorCode.SUCCESS.getCode(), resDeserialize.getErrorCode().intValue());
        Assert.assertEquals(presentation.toJson(), resDeserialize.getResult().toJson());
    }

    /**
     * 使用密文方式构建协议数据并解析, 涉及AMOP, 暂时忽略
     */
    @Test
    @Ignore
    ...
    public void testDeserializeCase3() {
        ...
        LogUtil.info(logger, "deserialize", resDeserialize);
        Assert.assertEquals(
            KitErrorCode.TRANSPORTATION_NO_SPECIFYER_TO_SET.getCode(),
    ...
    public void testDeserializeCase4() {
        ...
        if (resDeserialize.getErrorCode() == KitErrorCode.SUCCESS.getCode()) {
    ...
    public void testDeserializeCase7() {
        ...
        LogUtil.info(logger, "deserialize", resDeserialize);
        Assert.assertEquals(
            KitErrorCode.ENCRYPT_KEY_NO_PERMISSION.getCode(),
            resDeserialize.getErrorCode().intValue());
    }
