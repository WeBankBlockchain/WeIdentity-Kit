...
package com.webank.weid.kit.constant;
...
public enum KitErrorCode {
     ...
     */
    KitErrorCode(int code, String codeDesc) {
        this.code = code;
     ...
     * @return errorCode
     */
    public static KitErrorCode getTypeByErrorCode(int errorCode) {
        for (KitErrorCode type : KitErrorCode.values()) {
            if (type.getCode() == errorCode) {
                return type;
            }
        }
        return KitErrorCode.UNKNOW_ERROR;
    }
