...
package com.webank.weid.kit.endpoint;
...
public class EndpointDataUtil {
    ...
    public static synchronized void mergeToCentral(EndpointInfo endpointInfo) {
        ...
        for (EndpointInfo localInfo : tempList) {
            ...
            logger.debug("Merged Endpoint: " + KitUtils.serialize(localInfo));
            System.out.println("Merged Endpoint: " + KitUtils.serialize(localInfo));
        }
        if (!exists) {
            finalList.add(endpointInfo);
            logger.debug("Merged Endpoint: " + KitUtils.serialize(endpointInfo));
            System.out.println("Merged Endpoint: " + KitUtils.serialize(endpointInfo));
        }
