...
Pass the following arguments:
        * \`<repo>\`: ":user/:name" of the repository. For example, "afeexian/WeIdentity-Kit".
...
EXAMPLES:
        $ ./release.sh afeexian/WeIdentity-Kit v3.0.0 <token> -- dist/app/*.jar
        Creates a release named "v1.5.0" and adds any jar file in
        \`dist/app/\` as an asset.
        $ ./release.sh afeexian/WeIdentity-Kit v3.0.0 <token> -- dist/app/*.jar < notes.md
