...
# EXAMPLE:
#        $ ./auto-release.sh WeBankFinTech/WeIdentity-Kit v3.0.0 <token> v1.8.6
#
# Prerequisites:
# 1. Fill in signing and OSS account info in gradle.properties
# 2. pip install gitchangelog
# 3. Finish your CHANGELOG.md and also FINISHED MERGING the release to master (e.g. release/3.0.0 to master)
#
